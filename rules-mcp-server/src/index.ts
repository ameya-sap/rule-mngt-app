...
const getServer = () => {
  ...
  server.tool(
    ...
    "List available rules for a specific business category",
    {
  ...
  server.tool(
    "evaluate_rule_logic",
    "Evaluate a specific rule against provided data. Use this to deterministically check if conditions are met.",
    {
  ...
  server.tool(
    "get_rule_requirements",
    "Get the list of required fields for a specific rule to guide data extraction.",
    {
  ...
  server.tool(
    "get_all_categories",
    "Get a list of all available business categories to help discover rules.",
    {},
    async () => {
